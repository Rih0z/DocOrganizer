...
namespace DocOrganizer.Infrastructure.Tests.Services
{
    public class PdfRotationErrorTests
    {
        ...
        public PdfRotationErrorTests()
        {
            ...
            _editorService = new PdfEditorService(_mockPdfService.Object, _mockFileService.Object, _mockLogger.Object);
        }
