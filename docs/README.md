...
| バージョン | 内容 | レポート |
|-----------|------|---------|
| **V3.0.129** | 表示メニュー削除 | [📁 v3.0.129/](reports/v3.0.129/) |
| **V3.0.128** | UI簡素化実装 | [📁 v3.0.128/](reports/v3.0.128/) |
| **V3.0.127** | 回転後キーボードナビゲーションバグ修正 | [📁 v3.0.127/](reports/v3.0.127/) |
...
```
reports/
├── v3.0.129/          # V3.0.129 表示メニュー削除実装
├── v3.0.128/          # V3.0.128 UI簡素化実装
├── v3.0.127/          # V3.0.127 回転後キーボードナビゲーションバグ修正
...
| バージョン | 日付 | 主な変更 |
|-----------|------|----------|
| V3.0.129 | 2025-10-14 | 表示メニュー削除 |
| V3.0.128 | 2025-10-14 | UI簡素化実装 |
| V3.0.127 | 2025-10-14 | 回転後キーボードナビゲーションバグ修正 |
