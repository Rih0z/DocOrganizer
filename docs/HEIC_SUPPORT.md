...
#### Q: プレビューが小さすぎて読めない
**A:** V2.2.1で修正済みです：
- HEICファイルのプレビューサイズが自動的に適切なサイズ(600x800以上)に調整されます
- アスペクト比を維持しながら読みやすいサイズで表示されます
- 最新版のDocOrganizer.exeを使用してください
...
### V2.2.1 (2025-08-08) - プレビューサイズ問題修正
- **修正**: HEICファイル選択時のプレビューサイズ問題を完全解決
- **改善**: 小さなサムネイル(150x150)を適切な表示サイズ(600x800以上)に自動拡大
- **改善**: アスペクト比を維持した最適なプレビューサイズ計算
